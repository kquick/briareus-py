...
expected_repo_info = {
    ...
    'pullreqs': set([
        PRInfo(pr_target_repo='TheRepo',
               ...
               pr_branch='frog',
               pr_revision='frog_mergeref',
               pr_ident='91',
               pr_status=PRSts_Active(),
               pr_title='Croaking frogs',
               pr_user='frog',
               pr_email='frog@lilypond.pad'),
        PRInfo(pr_target_repo='TheRepo',
               pr_srcrepo_url='https://github.com/toad_repo_url',
               pr_branch='toad',
               pr_revision='toad_mergeref',
               pr_ident='134',
               pr_status=PRSts_Active(),
               pr_title='Hoppy toads',
               pr_user='hoppy',
               pr_email=''),
    ]),
    'subrepos': set([]),
