...
def verify_repo1_hydracfg(bpath, bldcfgs):
    ...
    assert_eqlist(other_bldcfgs,
                  [ os.path.join(bpath,
                                 'hydra/Repo1/Repo1-hydra-project-config.json'),
                    os.path.join(bpath,
                                 'hydra/Repo1/Repo1-hydra-inputs-config.json'),
                    os.path.join(bpath, 'hydra/_common/gen_inpupd.nix'),
                    os.path.join(bpath, 'hydra/Repo1/Repo1_inpupd_jobsets.json'),
                    os.path.join(bpath, 'hydra/Repo1/Repo1-updinputs.nix'),
                    os.path.join(bpath, 'hydra/_common/gen_proj_jobsets.nix'),
                    'Repo1.txt',
                  ])
    ...
    VerifyJobsetDesc(
        ...
        *tuple([
            VerifyBldCfg('develop.HEADs-' + ghcver,
                     ...
                     # VerifyInput('Repo2-src', 'git', 'https://github.com/r2_url develop'),
                     # VerifyInput('Repo3-src', 'git', 'https://gitlab.com/r3_url develop'),
                     # VerifyInput('Repo4-src', 'git', 'https://github.com/r4_url master'),
        ...
        *tuple([
            VerifyBldCfg('develop.submodules-'+ghcver,
                         ...
                         # VerifyInput('Repo1-src', 'git', 'r1_url develop'),
                         # VerifyInput('Repo2-src', 'git', 'https://github.com/r2_url r2_develop_head'),
                         # VerifyInput('Repo3-src', 'git', 'https://gitlab.com/r3_url r3_develop_head'),
                         # VerifyInput('Repo4-src', 'git', 'https://github.com/r4_url r4_master_head'),
                         VerifyInput('ghcver', 'string', ghcver),
                         VerifyInput('variant', 'string', 'branch=develop', contains=True),
        ...
        *tuple([
            VerifyBldCfg('master.HEADs-' + ghcver,
                     ...
                     # VerifyInput('Repo2-src', 'git', 'https://github.com/r2_url master'),
                     # VerifyInput('Repo3-src', 'git', 'https://gitlab.com/r3_url master'),
                     # VerifyInput('Repo4-src', 'git', 'https://github.com/r4_url master'),
                     VerifyInput('ghcver', 'string', ghcver),
        ...
        *tuple([
            VerifyBldCfg('master.submodules-'+ghcver,
                         ...
                         # VerifyInput('Repo1-src', 'git', 'r1_url master'),
                         # VerifyInput('Repo2-src', 'git', 'https://github.com/r2_url r2_master_head'),
                         # VerifyInput('Repo3-src', 'git', 'https://gitlab.com/r3_url r3_master_head^3'),
                         # VerifyInput('Repo4-src', 'git', 'https://github.com/r4_url r4_master_head^1'),
                         VerifyInput('ghcver', 'string', ghcver),
                         VerifyInput('variant', 'string', 'branch=master', contains=True),
                         VerifyInput('variant', 'string', 'strategy=submodules', contains=True))
            for ghcver in ["ghc844", "ghc865", "ghc881"]]),
    ...
    verify_cfg_instructions(bpath, bldcfgs['Repo1.txt'])
    ...
    VerifyProjectCfg(
        ...
        VerifyInput('mkjobsets', 'path', bpath + '/hydra/_common'),
    ...
    ).verify(json.loads(bldcfgs[os.path.join(bpath,
                                             'hydra/Repo1/Repo1-hydra-project-config.json')]))

    # The nix expression to generate the .jobsets for the project.  It
    # should copy the projcfg input to the store
    gen_proj_jobsets = bldcfgs[bpath + '/hydra/_common/gen_proj_jobsets.nix']
    ...
    gen_inpupd = bldcfgs[bpath + '/hydra/_common/gen_inpupd.nix']
    ...
    VerifyJobsetDesc(
        VerifyBldCfg("update_inputs",
                     ...
                     VerifyInput('realize_inputs', 'path', bpath + '/hydra/Repo1'),
                     # Repo1-cfg-inp is KWQ? to re-run this if the input config changes??
                     VerifyInput('Repo1-cfg-inp', 'path', bpath + '/inp_example2'),

                     VerifyInput('Repo1-develop-src', 'git', 'https://github.com/r1_url develop'),
                     VerifyInput('Repo2-develop-src', 'git', 'https://github.com/r2_url develop'),
                     VerifyInput('Repo3-develop-src', 'git', 'https://gitlab.com/r3_url develop'),
                     # VerifyInput('Repo4-develop-src', 'git', 'https://github.com/r4_url master'),

                     # VerifyInput('Repo1-develop-src', 'git', 'https://github.com/r1_url develop'),
                     VerifyInput('Repo2-r2---develop---head-src', 'git', 'https://github.com/r2_url r2_develop_head'),
                     VerifyInput('Repo3-r3---develop---head-src', 'git', 'https://gitlab.com/r3_url r3_develop_head'),
                     VerifyInput('Repo4-r4---master---head-src', 'git', 'https://github.com/r4_url r4_master_head'),

                     VerifyInput('Repo1-master-src', 'git', 'https://github.com/r1_url master'),
                     VerifyInput('Repo2-master-src', 'git', 'https://github.com/r2_url master'),
                     VerifyInput('Repo3-master-src', 'git', 'https://gitlab.com/r3_url master'),
                     VerifyInput('Repo4-master-src', 'git', 'https://github.com/r4_url master'),

                     # VerifyInput('Repo1-src', 'git', 'https://github.com/r1_url master'),
                     VerifyInput('Repo2-r2---master---head-src', 'git', 'https://github.com/r2_url r2_master_head'),
                     VerifyInput('Repo3-r3---master---head^3-src', 'git', 'https://gitlab.com/r3_url r3_master_head^3'),
                     VerifyInput('Repo4-r4---master---head^1-src', 'git', 'https://github.com/r4_url r4_master_head^1'),
    ...
    ).verify(bldcfgs[bpath + '/hydra/Repo1/Repo1_inpupd_jobsets.json'])

    # The Repo1_updinputs.nix is the main nix expression that is
    # associated with the update_inputs jobset.
    updinp_expr = bldcfgs[bpath + '/hydra/Repo1/Repo1-updinputs.nix']
...
def verify_alt_proj_hydracfg(bpath, bldcfgs):
    ...
    assert_eqlist(other_bldcfgs,
                  [ os.path.join(bpath,
                                 'hydra/alt-proj/alt-proj-hydra-project-config.json'),
                    os.path.join(bpath,
                                 'hydra/alt-proj/alt-proj-hydra-inputs-config.json'),
                    os.path.join(bpath, 'hydra/_common/gen_inpupd.nix'),
                    os.path.join(bpath, 'hydra/alt-proj/alt-proj_inpupd_jobsets.json'),
                    os.path.join(bpath, 'hydra/alt-proj/alt-proj-updinputs.nix'),
                    os.path.join(bpath, 'hydra/_common/gen_proj_jobsets.nix'),
                    'alt-proj.txt',
                  ])
    ...
    VerifyJobsetDesc(
        ...
        VerifyBldCfg('master.HEADs-ghc865',
                     ...
                     # VerifyInput('Repo3-src', 'git', 'https://gitlab.com/r3_url master'),
                     # VerifyInput('Repo4-src', 'git', 'https://github.com/r4_url master'),
                     # VerifyInput('RAdd1-src', 'git', 'https://github.com/ra1_url master'),
                     # VerifyInput('RAdd2-src', 'git', 'https://github.com/ra2_url master'),
    ...
    verify_cfg_instructions(bpath, bldcfgs['alt-proj.txt'])
    ...
    VerifyProjectCfg(
        ...
        # the nixexprpath
        VerifyInput('inpupd_jobset_def', 'path',
                    bpath + '/hydra/alt-proj/alt-proj_inpupd_jobsets.json'),
        # nixpkgs is needed for the gen_proj_jobsets.nix expression
        admin_nixpkgs,
        nixexprinput = 'inpupd_cfg',
        nixexprpath = 'gen_inpupd.nix',
    ...
    VerifyJobsetDesc(
        VerifyBldCfg("update_inputs",
                     # realize_inputs is where the nixexprpath is obtained from
                     VerifyInput('realize_inputs', 'path', bpath + '/hydra/alt-proj'),
                     # Repo1-cfg-inp is KWQ? to re-run this if the input config changes??
                     ...
                     VerifyInput('Repo3-master-src', 'git', 'https://gitlab.com/r3_url master'),
                     VerifyInput('Repo4-master-src', 'git', 'https://github.com/r4_url master'),
                     VerifyInput('RAdd1-master-src', 'git', 'https://github.com/ra1_url master'),
                     VerifyInput('RAdd2-master-src', 'git', 'https://github.com/ra2_url master'),
    ...
    ).verify(bldcfgs[bpath + '/hydra/alt-proj/alt-proj_inpupd_jobsets.json'])

    # The Repo1_updinputs.nix is the main nix expression that is
    # associated with the update_inputs jobset.
    updinp_expr = bldcfgs[bpath + '/hydra/alt-proj/alt-proj-updinputs.nix']
    assert_in('Repo1-master-src', updinp_expr)
    assert_in('Repo2-master-src', updinp_expr)
    assert_in('Repo3-master-src', updinp_expr)
    assert_in('Repo4-master-src', updinp_expr)
...
def verify_cfg_instructions(bpath, instrs):
    ...
    assert_in(os.path.join(bpath, 'hydra'), instrs)
