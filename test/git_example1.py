    ...
    def __init__(self, *args, **kw):
        ...
        self.pullreqs.update({
            ...
            'R3': [PullReqInfo("11",
                               ...
                               pullreq_email='nick@bad.seeds'),
                   PullReqInfo("22",
                               pullreq_status=PRSts_Closed(),
                               pullreq_title='ignored because closed',
                               pullreq_srcurl='remote_r3_CLOSED_url',
                               pullreq_branch='closed_pr',
                               pullreq_ref='r3_CLOSED_mergeref',
                               pullreq_user='done',
                               pullreq_email='done@already.yo'),
                   PullReqInfo("33",
                               pullreq_status=PRSts_Merged(),
                               pullreq_title='ignored because merged',
                               pullreq_srcurl='remote_r3_MERGED_url',
                               pullreq_branch='merged_pr',
                               pullreq_ref='r3_MERGED_mergeref',
                               pullreq_user='done',
                               pullreq_email='done@already.yo'),
            ],
            'R4': [PullReqInfo("8192",
